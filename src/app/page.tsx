...
const TIME_SLOTS: TimeSlot[] = [
  { time: "07:00", endTime: "08:00", available: true, period: "morning" },
  { time: "08:00", endTime: "09:00", available: true, period: "morning" },
  { time: "09:00", endTime: "10:00", available: false, period: "morning" },
  { time: "10:00", endTime: "11:00", available: true, period: "morning" },
  { time: "11:00", endTime: "12:00", available: true, period: "morning" },
  { time: "14:00", endTime: "15:00", available: true, period: "afternoon" },
  { time: "15:00", endTime: "16:00", available: true, period: "afternoon" },
  { time: "16:00", endTime: "17:00", available: true, period: "afternoon" },
  { time: "17:00", endTime: "18:00", available: true, period: "night" },
  { time: "18:00", endTime: "19:00", available: false, period: "night" },
  { time: "19:00", endTime: "20:00", available: true, period: "night" },
  { time: "20:00", endTime: "21:00", available: true, period: "night" },
];
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
        {slots.map((slot) =>
          !slot.available ? (
            ...
            >
              <span className="block text-base font-bold text-on-surface-variant/40">{slot.time}</span>
              <span className="text-[10px] text-on-surface-variant/40 line-through">Reservado</span>
            </div>
          ) : (
            <button
              key={slot.time}
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[480px] md:min-h-[520px] flex items-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-20 max-w-7xl">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <motion.span variants={fadeInVariants} className="inline-block px-4 py-1.5 bg-secondary-container text-primary font-bold text-xs tracking-widest uppercase rounded-full mb-4">
              Reserve sua Quadra
            </motion.span>
            <motion.h1 variants={fadeInVariants} className="text-white text-4xl md:text-6xl font-extrabold tracking-tight leading-[0.95] mb-5">
              Tennis House Urbanova
            </motion.h1>
            <motion.p variants={fadeInVariants} className="text-white/80 text-lg md:text-xl mb-8 max-w-xl font-body leading-relaxed">
              Agende seu horário agora e garanta sua quadra. Rápido, fácil e direto.
            </motion.p>
      ...
      {/* =====================================================
          ...
          ===================================================== */}
      <section className="py-16 md:py-20 bg-surface-container-lowest" id="reservar">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-5 md:p-8 shadow-sm border border-primary/5">
                <div className="flex items-center space-x-3 mb-6">
                  <span className="bg-primary text-white w-8 h-8 flex items-center justify-center rounded-full font-bold text-sm">1</span>
                  <h3 className="text-lg font-bold text-primary">Escolha a Data</h3>
                </div>
                <div className="grid grid-cols-7 gap-1.5 md:gap-2 text-center">
                  {WEEKDAY_LABELS.map((label) => (
                    <div key={label} className="text-[10px] uppercase tracking-widest font-bold text-on-surface-variant opacity-50 py-2">
                      {label}
                    </div>
                  ))}
              ...
              <div className="bg-white rounded-2xl p-5 md:p-8 shadow-sm border border-primary/5">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    <span className="bg-primary text-white w-8 h-8 flex items-center justify-center rounded-full font-bold text-sm">2</span>
                    <h3 className="text-lg font-bold text-primary">Escolha o Horário</h3>
                  </div>
            ...
            <aside className="lg:col-span-4 lg:sticky lg:top-24">
              <div className="bg-primary text-white rounded-2xl overflow-hidden shadow-2xl">
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-6">
                    ...
                    <h3 className="text-lg font-bold leading-tight">Sua Reserva</h3>
                  </div>
                </div>
                <div className="p-6 space-y-5">
                  ...
                  <div className="pt-5 border-t border-white/10">
                    <div className="flex justify-between items-end">
                      <div>
                        <span className="text-[10px] uppercase tracking-widest text-white/50 font-bold">Valor</span>
              ...
              <div className="mt-4 p-4 bg-secondary/10 rounded-xl flex items-start space-x-3">
                ...
                <p className="text-xs text-primary/70 leading-relaxed">
                  Cancelamento grátis até 24h antes. Equipamentos podem ser alugados na recepção.
                </p>
              </div>
            </aside>
          </motion.div>
      ...
      <section className="py-20 bg-surface-container-low overflow-hidden" id="detalhes">
        <div className="container mx-auto px-6 max-w-7xl">
          <motion.div
            initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeInVariants}
            className="mb-14 text-center"
          >
            <span className="inline-block px-4 py-1.5 bg-secondary-container text-primary font-bold text-xs tracking-widest uppercase rounded-full mb-4">Você Sabia?</span>
            <h2 className="text-3xl md:text-4xl font-black text-primary tracking-tighter mb-3 uppercase">Benefícios do Tênis</h2>
            <p className="text-on-surface-variant max-w-2xl mx-auto">Descubra como o tênis pode transformar seu corpo, mente e vida social.</p>
          </motion.div>
          ...
          >
            {BENEFITS.map((benefit, index) => (
              ...
              >
                ...
                <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${benefit.color} flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500`}>
                  <span className="material-symbols-outlined text-white text-2xl">{benefit.icon}</span>
                </div>
                <h3 className="text-lg font-extrabold text-primary tracking-tight mb-2">{benefit.title}</h3>
      ...
      <section className="py-20 bg-surface-container-lowest" id="localizacao">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col md:flex-row gap-16 items-stretch">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-black text-primary mb-6">Onde a Paixão Encontra o Jogo</h2>
